...
def encode_text(examples):
    ...
    return tokenizer(
        ...
        padding=False # Using dynamic padding. See Data collator
    )
...
with open("/work/Ccp-OldNewsBERT_2024/output/eval_results/ON-BERT_v3_eval_results-07-10-25.json", "w") as f:
