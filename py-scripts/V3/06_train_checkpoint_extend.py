...
tokenizer = BertTokenizerFast.from_pretrained('/work/Ccp-OldNewsBERT_2024/tokenizer/V3', local_files_only=True)
# Load model
checkpoint_path = "/work/Ccp-OldNewsBERT_2024/modelling/V3/models/ON-BERT-v3/checkpoint-98640"
model = AutoModelForMaskedLM.from_pretrained(checkpoint_path, local_files_only=True)
set_seed(42)
...
# train the model
trainer.train(resume_from_checkpoint='/work/Ccp-OldNewsBERT_2024/modelling/V3/models/ON-BERT-v3/checkpoint-98640')